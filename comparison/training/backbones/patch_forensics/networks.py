...
from .....iab_clone.ImageAttributionBench.training.backbones.patch_forensics import netutils
...
def define_D(which_model_netD, init_type, gpu_ids=[]):
    if 'resnet' in which_model_netD:
        ...
        from .....iab_clone.ImageAttributionBench.training.backbones.patch_forensics import xception
...
def define_patch_D(which_model_netD, init_type, gpu_ids=[], num_class=2):
    if which_model_netD.startswith('resnet'):
        ...
        from .....iab_clone.ImageAttributionBench.training.backbones.patch_forensics import customnet
