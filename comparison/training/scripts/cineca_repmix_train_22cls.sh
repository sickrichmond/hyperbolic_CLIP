#!/bin/bash
# RepMix (Bui et al., ECCV 2022) attributor @ 22 CLASSES (dalle3 excluded).
# Hyperparameters from the IAB reference script training/scripts/repmix.bash
...
# Submit: sbatch comparison/training/scripts/cineca_repmix_train_22cls.sh
#SBATCH --account=EUHPC_D35_189
#SBATCH --partition=boost_usr_prod
#SBATCH --qos=boost_qos_lprod
#SBATCH --job-name=iab_repmix_train_22
#SBATCH --nodes=1
...
echo "Done (22cls). Results under comparison/training/logs/default_split/repmix/<run>/"
