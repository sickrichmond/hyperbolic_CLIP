...
from comparison.training.backbones.ucf import BACKBONE
from comparison.training.loss.ucf import LOSSFUNC
...
class UCFAttributor(AbstractAttributor):
    ...
    def build_model(self,config):
        ...
        # head
        specific_task_number = config.get("specific_task_number", len(model_class_to_label))  # attribution classes
        self.head_spe = Head(
