...
#    python dataset_rebuilding/check_captions.py ... --write_clean $WORK/hyp_fine_tuning/iab_captions_detailed_clean)
#
...
CAPS="$WORK/hyp_fine_tuning/iab_captions_detailed_clean"
DATA="$WORK/hyp_fine_tuning/iab_dataset"
OUT="$WORK/hyp_fine_tuning/iab_recap_dataset"
